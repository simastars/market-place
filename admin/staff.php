            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="text-center">LIST OF ALL REGISTERED STAFF</h3>
                                ...
                                $sql = "SELECT * FROM registration WHERE status = 'Staff' ";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    for ($i=0; $i < mysqli_num_rows($result); $i++) { 
                                              ...
                                              echo "<tr>
                                                ...
                                                <td>$email</td>
                                                <td>
                                                <a href='staff.php?id=$serial' class='btn btn-danger'>Delete</a>
                                                </td>
