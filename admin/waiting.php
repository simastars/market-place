...
<head>
  ...
  <link href="../images/logo.png" rel="apple-touch-icon">
    ...
    <!-- Title Page-->
    <title>Registered waiting</title>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="text-center">LIST OF ALL REGISTERED waiting</h3>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    for ($i=0; $i < mysqli_num_rows($result); $i++) { 
                                              ...
                                              echo "<tr>
                                                ...
                                                <td>
                                                <a href='waiting.php?rq=$serial' class='btn btn-success'>Approve</a>
                                                </td>
                                               
                                                <td>
                                                <a href='waiting.php?id=$serial' class='btn btn-danger'>Reject</a>
                                                </td>
